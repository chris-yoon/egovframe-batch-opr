...
public class EgovUserManageController {
	...
	public String updateUserPassword(@ModelAttribute("userManage") UserManageVO userManageVO, BindingResult bindingResult, Model model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			//비밀번호 암호화
			String searchPassword = EgovFileScrty.encryptPassword(userManageVO.getSearchKeyword(), userManageVO.getLoginId());
			String newPassword = EgovFileScrty.encryptPassword(userManageVO.getPassword(), userManageVO.getLoginId());
	...
	public String insertUser(@ModelAttribute("userManage") UserManage userManage, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			//비밀번호 암호화
			String enpassword = EgovFileScrty.encryptPassword(userManage.getPassword(), userManage.getLoginId());
	...
	public String updateUser(final MultipartHttpServletRequest multiRequest, @ModelAttribute("userManage") UserManage userManage, BindingResult bindingResult,
	...
	public String deleteUser(@ModelAttribute("userManage") UserManage userManage, SessionStatus status, Model model) throws Exception {
	...
	public String deleteUserList(@RequestParam("userId") String userId, @ModelAttribute("userManage") UserManage userManage, SessionStatus status, Model model) throws Exception {
	...
	public String selectUser(@RequestParam("userId") String userId, @ModelAttribute("userManageVO") UserManageVO userManageVO, ModelMap model) throws Exception {
	...
	public String selectAuthorListPopUp(@ModelAttribute("userManageVO") UserManageVO userManageVO, ModelMap model) throws Exception {
