...
public class EgovRoleManageController {
	...
	public String selectRoleList(@ModelAttribute("roleManageVO") RoleManageVO roleManageVO,
    	...
    	PaginationInfo paginationInfo = PageUtl.getPaginationInfo(roleManageVO);
    	paginationInfo.setTotalRecordCount(egovRoleManageService.selectRoleListTotCnt(roleManageVO));
