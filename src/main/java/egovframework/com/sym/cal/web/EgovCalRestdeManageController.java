...
public class EgovCalRestdeManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/callCalPopup.do")
	...
	@RequestMapping(value="/com/sym/cal/callCal.do")
 	public String callCal (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {

		//2011.10.18 달력 출력을 위해 필요한 숫자 이외의 값을 사용하는 경우 체크
		BindingResult bindingResult = checkRestdeWithValidator(restde, bindingResultTmp);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovNormalCalPopup.do")
 	public String callNormalCalPopup (Restde restde, BindingResult bindingResultTmp,
 			ModelMap model
 			) throws Exception {
		//2011.10.18 달력 출력을 위해 필요한 숫자 이외의 값을 사용하는 경우 체크
		BindingResult bindingResult = checkRestdeWithValidator(restde, bindingResultTmp);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovAdministCalPopup.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovselectAdministCalendar.do")
 	public String selectAdministRestdePopup (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	...
	@RequestMapping(value="/com/sym/cal/EgovNormalDayCalendar.do")
 	public String selectNormalDayCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/com/sym/cal/EgovNormalWeekCalendar.do")
 	public String selectNormalWeekCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovNormalMonthCalendar.do")
 	public String selectNormalMonthCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovNormalYearCalendar.do")
 	public String selectNormalYearCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/com/sym/cal/EgovAdministDayCalendar.do")
 	public String selectAdministDayCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/com/sym/cal/EgovAdministWeekCalendar.do")
 	public String selectAdministWeekCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovAdministMonthCalendar.do")
 	public String selectAdministMonthCalendar (Restde restde, BindingResult bindingResultTmp
 			, ModelMap model
 			) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/com/sym/cal/EgovAdministYearCalendar.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/com/sym/cal/EgovRestdeRegist.do")
     ...
     * @throws Exception
     */
	@RequestMapping(value="/com/sym/cal/EgovRestdeDetail.do")
     ...
     * @throws Exception
     */
	@IncludedInfo(name="공휴일관리(달력)", listUrl="/com/sym/cal/EgovRestdeList.do", order = 1300 ,gid = 90)
    @RequestMapping(value="/com/sym/cal/EgovRestdeList.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/com/sym/cal/EgovRestdeModify.do")
