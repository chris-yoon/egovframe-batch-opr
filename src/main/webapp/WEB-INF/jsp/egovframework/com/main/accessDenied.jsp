        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="board_title">[ 접근거부 ] 해당 요청에 대한 권한이 없습니다. <br> 관리자에게 문의하시기 바랍니다.</td>
                  </tr>
                </table>
        	 </td>
              </tr>
              ...
              <tr>
                <td align="center"><a href="#LINK" onclick="history.back(); return false;"><img src="<c:url value='/images/egovframework/com/cmm/go_history.jpg' />" alt="이전화면으로" border="0" /></a></td>
              </tr>
            </table>
              <br /></td>
          </tr>
