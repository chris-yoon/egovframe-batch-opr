...
function fn_egov_update_view(){
    ...
    varForm.action = "/com/sym/bat/getBatchOpertForUpdate.do";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "/com/sym/bat/deleteBatchOpert.do";
            vForm.submit();
        }
}
</script>
...
<form name="batchOpertForm"  id="batchOpertForm" action="<c:url value='/com/sym/bat/getBatchOpert.do'/>" method="post">
    ...
    <tr> 
        <td>
            <span class="button">
            <a href="<c:url value='/com/sym/bat/getBatchOpertForUpdate.do'>
                     </c:url>"
