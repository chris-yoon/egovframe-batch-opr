...
<script type="text/javascript">
    ...
    function fn_egov_get_list(pageNo) {
        ...
        document.frm.action = "<c:url value='/com/sym/bat/getBatchOpertList.do'/>";
        document.frm.submit();
    }

    function fn_egov_get_detail_view(batchOpertId) {
        document.frm.batchOpertId.value = batchOpertId;
        document.frm.action = "<c:url value='/com/sym/bat/getBatchOpert.do'/>";
        document.frm.submit();
    }
    /* ********************************************************
     * 등록 처리 함수
    ...
    function fn_egov_get_regist_view(){
        document.frm.action = "<c:url value='/com/sym/bat/getBatchOpertForRegist.do'/>";
        document.frm.submit();
    }
</script>
...
<div id="border" style="width:712px">
    ...
    <form name="frm" id="frm" action="<c:url value='/com/sym/bat/getBatchOpertList.do'/>" method="post">
      ...
      <th width="20%" align="right">
           <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td>
                   <span class="button">
                   <a href="<c:url value='/com/sym/bat/getBatchOpertForRegist.do'>
                            </c:url>"
    ...
    <table width="100%" cellpadding="8" class="table-list" summary="배치작업에 대한 목록을 제공합니다.">
     ...
     <tbody>
        ...
        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
          <tr>
                <td class="lt_text3">
                    <form name="item" method="post" action="<c:url value='/com/sym/bat/getBatchOpert.do'/>">
