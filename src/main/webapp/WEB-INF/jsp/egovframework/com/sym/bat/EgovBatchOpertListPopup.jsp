...
<script type="text/javascript">
    ...
    function fn_egov_get_list(pageNo) {
        ...
        document.frm.action = "<c:url value='/com/sym/bat/getBatchOpertList.do?popupAt=Y'/>";
        document.frm.submit();  
    }
...
<div id="border" style="width:712px">
    ...
    <form name="frm" id="frm" action="<c:url value='/com/sym/bat/getBatchOpertList.do?popupAt=Y'/>" method="post">
