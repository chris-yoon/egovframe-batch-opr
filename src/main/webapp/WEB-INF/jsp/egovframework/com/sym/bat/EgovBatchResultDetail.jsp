...
function fn_egov_list(){
    ...
    varForm.action = "/com/sym/bat/getBatchResultList.do";
    varForm.submit()
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "/com/sym/bat/deleteBatchResult.do";
            vForm.submit();
        }
}
</script>
...
<form name="batchResultForm"  id="batchResultForm" action="<c:url value='/com/sym/bat/getBatchResult.do'/>" method="post">
    ...
    <tr> 
        ...
        <td>
            <span class="button">
            <a href="<c:url value='/com/sym/bat/getBatchResultList.do'>
                     </c:url>"
