...
function fn_egov_get_list(pageNo) {
    ...
    */
    ...
    document.frm.action = "<c:url value='/com/sym/bat/getBatchResultList.do'/>";
    document.frm.submit();
}
...
function fn_egov_get_detail_view(batchResultId) {
    ...
    document.frm.action = "<c:url value='/com/sym/bat/getBatchResult.do'/>";
    document.frm.submit();
}
</script>
</head>
...
<div id="border" style="width:712px">
    ...
    <form name="frm" id="frm" action="<c:url value='/com/sym/bat/getBatchResultList.do'/>" method="post">
    ...
    <table width="100%" cellpadding="8" class="table-list" summary="배치결과에 대한 목록을 제공합니다.">
     ...
     <tbody>
        ...
        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
          <tr>
                <td class="lt_text3">
                    <form name="item" method="post" action="<c:url value='/com/sym/bat/getBatchResult.do'/>">
