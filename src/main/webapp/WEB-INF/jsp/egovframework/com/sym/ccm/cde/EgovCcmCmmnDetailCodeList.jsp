...
<div class="contsBody">
	<h2>공통상세코드 관리</h2>
	<div class="location">공통코드 관리 > 공통상세코드 관리 > <strong>목록</strong></div>
	...
	<div class="Btn">
		<span class="bbsBtn"><a href="javascript:fnRegist();" title="공통상세코드 등록화면으로 이동">등록</a></span>
	</div>

	<div class="bbsList">
		<table  summary="순번, 코드ID, 코드, 코드명, 사용여부의 순서로 보여지는 공통상세코드관리 목록입니다.">
		<caption>공통상세코드관리 목록</caption>
		<colgroup>
			<col style="width:10%" >
			<col style="width:20%" >
			<col style="width:30%" >
		...
		<tr>
			...
			<td class="left"><a href="<c:url value='/sym/ccm/cde/EgovCcmCmmnDetailCodeDetail.do'/>?codeId=${resultInfo.codeId}&amp;code=${resultInfo.code}" onclick="javascript:fnDetail('${resultInfo.codeId}','${resultInfo.code}');" title="공통상세코드 상세화면으로 이동">
				${resultInfo.codeNm}</a>
			</td>
